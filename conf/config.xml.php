...
<entries>
	...
	<entry key="Username" value="__ADMIN__" />
	<!-- REQUIRED, throws custom exception if missing -->
	<entry key="Password" value="__PASSWORD__" />
	<!-- optional, may be left out or empty - defaults to 'en' -->
	<entry key="Language" value="__LANGUAGE__" />
	...
	<entry key="DatabaseConnection" value="localhost;__DB_NAME__;__DB_USER__;__DB_PWD__" />
	<!-- optional, may be left out or empty - defaults to False -->
	...
	<entry key="SMTPDKIMDomain" value="__DOMAIN__" />
